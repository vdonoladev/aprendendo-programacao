...
ret_pr = print(numeros) # Função print não retorna nada

print(f'Retorno de print: {ret_pr}') # None
...
def diz_oi():
	...
	return 'Oi! '
	print('Estou sendo executado após o retorno...') # Após o return nada é executado!
...
# Erros comuns na utilização do retorno, que na verdade nem é erro, mas si codificação desnecessária.
