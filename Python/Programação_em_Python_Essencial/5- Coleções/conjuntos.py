...
# Removendo elementos em um conjunto (set)
...
# {'Patricia', 'Guilherme', 'Marcos', 'Ellen', 'Pedro', 'Ana', 'Fernando', 'Gustavo', 'Julia'}
# unicos1 = estudantes_java.union(estudantes_python)
# {'Fernando', 'Gustavo', 'Marcos', 'Julia', 'Patricia', 'Guilherme', 'Pedro', 'Ana', 'Ellen'}
print(unicos1)
