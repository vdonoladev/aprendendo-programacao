...
tupla = ('Geek Unviversity', 'Programação em Python: Essencial')
...
# Verificamos em qual indice um elemento está na lista
...
# - Tuplas deixam seu código mais seguro*. # * Isso porque trabalhar com elementos imutáveis trazem segurança para o código.
